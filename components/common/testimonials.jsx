        ...
        <div className=" overflow-hidden py-10 px-4 bg-white">
            ...
            <div className="max-w-[1860px] overflow-hidden mx-auto ">
                <div className="relative  px-1 xl:px-10 pt-12 pb-10 sm:pt-16">
                    ...
                    <button
                        onClick={scrollPrev}
                        className=" hidden sm:block sm:absolute left-4 xl:left-[9rem] top-1/2 transform -translate-y-1/2 z-20 bg-white  rounded-full p-3 border border-gray-100 hover:bg-gray-50 transition-all duration-200 hover:scale-110"
                    >
                    ...
                    <button
                        onClick={scrollNext}
                        className="hidden sm:block sm:absolute right-4 xl:right-[9rem] top-1/2 transform -translate-y-1/2 z-20 bg-white  rounded-full p-3 hover:bg-gray-50  border-gray-100 transition-all duration-200 hover:scale-110"
                    >
                        ...
                        <div className="flex flex-row    snap-x snap-mandatory">
                            {data.map((item, index) => (
                                <div
                                    ...
                                    key={index}
                                    className="min-w-[300px] mr-4 snap-start max-w-xs xl:max-w-sm relative bg-white border border-gray-100 rounded-2xl shadow-lg p-6 flex-shrink-0"
                                >
                                    ...
                                    <div className="flex flex-col gap-6 justify-between h-full">
                                        <div className="font-circular pt-8 text-gray-700 text-base leading-relaxed">
                                            {`"${item.review}"`}
                                        </div>
