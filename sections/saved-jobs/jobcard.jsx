...
import { Building2, CheckCircle, Clock, ExternalLink, MapPin, Users } from "lucide-react"
...
const JobCard = ({ job }) => {
    ...
    return (
        <>
            <div className="bg-white border border-gray-200 rounded-lg p-6 w-full shadow-sm hover:shadow-md transition-shadow duration-300">
            ...
            <Sheet open={isSheetOpen} onOpenChange={setIsSheetOpen}>
                <SheetContent className="!w-full rounded-4xl flex flex-col  rounded-r-none !max-w-[70rem] p-4 sm:p-6  overflow-y-auto">
                    ...
                    <SheetHeader className="py-[1rem] !px-0">
                        <div className="flex md:flex-row flex-col items-start gap-4">
                            ...
                            <div className="flex flex-col gap-2">
                                <div className="flex items-center gap-2">
                                    <SheetTitle className="font-circular line-clamp-1 font-semibold text-xl text-gray-900 leading-tight">
                                        {job.job_title}
                                    </SheetTitle>
